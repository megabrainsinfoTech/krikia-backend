...
export const databaseConfig: SequelizeModuleAsyncOptions = {
  useFactory: async () => {
    ...
    sequelize.addModels([User, Business, Listing, ListingAmenity, ListingLocation, ListingLandmark, ListingFAQ, House, ListingPlan, ListingPlanDimension, ListingPlanOption, Customer, Purchase, Review, ReviewReply, SiteInspection, NextOfKin, Wishlist, UserBusiness, SharedWishlist, ImageLabel, Image, ListingImage, BusinessImage, PromoCode]);
