import { Body, Controller, Delete, Get, HttpStatus, Param, Patch, Post, Req, Res, UsePipes, ValidationPipe } from '@nestjs/common';
...
export class UserController {
    ...
    bookForSiteInspection(@Body() createSiteInspectionBody: CreateSiteInspectionDTO){
    ...
    @Post('wishlist/share')
    async createSharedWishlist(@Body() createSharedWishlistBody: CreateSharedWishlistDTO){
        return await this.userService.createSharedWishlist(createSharedWishlistBody);
    }
